...
level03:level04
    | level03 T_LESS_EQUAL level04 {$$=new Less_Equal($1,$3);}
    | level03 T_GREATER_EQUAL  level04 {$$=new Greater_Equal($1,$3);}
    | level03 T_LESS level04 {$$=new Less($1,$3);}
    | level03 T_GREATER  level04 {$$=new Greater($1,$3);}

level04:level05
    | level04 T_EQUAL level05 {$$=new Equal($1,$3);}
    | level04 T_NOT_EQUAL level05 {$$=new Not_Equal($1,$3);}
...
level08:expression              {$$=$1;}
    | level08 T_NEAR expression {$$=nullptr; /*CHANGE*/}
    | level08 T_TOUCHES expression {$$=nullptr; /*CHANGE*/}
