...
initialization_block:
    T_INITIALIZATION statement_block
    {
      ...
      ev_man.add_handler(Window::INITIALIZE, $2);
    }
...
termination_block:
    ...
    {
      Event_manager& ev_man = Event_manager::instance();
      ev_man.add_handler(Window::TERMINATE, $2);
    }
...
forward_declaration:
    ...
    {
      Scope_manager& scopeman=Scope_manager::instance();
      Animation_code* a = new Animation_code(*$3, $5);
      if(scopeman.defined_in_current_scope(*$3))
      {
        Error::error(Error::PREVIOUSLY_DECLARED_VARIABLE,*$3);
        break;
      }
      scopeman.add_to_current_scope(std::make_shared<Symbol>(*$3, a));
      a->declared_blocklist.insert(*$3);
    }


//---------------------------------------------------------------------
animation_parameter:
    object_type T_ID {$$=$1; $2=$2;}
    | object_type {$$=$1;}
